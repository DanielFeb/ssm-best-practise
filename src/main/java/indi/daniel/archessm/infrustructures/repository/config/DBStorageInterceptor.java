...
public class DBStorageInterceptor {
    ...
    @Pointcut("execution(* indi.daniel.archessm.infrustructures.repository.dao..insert*(..))")
    public void insertData() {
    }

    @Pointcut("execution(* indi.daniel.archessm.infrustructures.repository.dao..updateByPrimaryKey*(..))")
